...
namespace ActionEditor
{
    ...
    public class ObjectSelectorWindow : EditorWindow
    {
        ...
        public static void ShowObjectPicker<T>(Object obj, Action<Object> itemSelectedCallback,
            string folderPath = "Assets", Func<string, bool> fit = null) where T : Object
        {
            Type typeFromHandle = typeof(T);
            get.Show(obj, typeFromHandle, null, itemSelectedCallback, folderPath, fit);
        }
        ...
        public static void ShowObjectPicker<T>(Object obj, string requiredTypeName,
            ...
            string folderPath = "Assets", Func<string, bool> fit = null) where T : Object
        {
            get.Show(obj, requiredTypeName, null, itemSelectedCallback, folderPath, fit);
        }
        ...
        public void Show(Object obj, Type requiredType, SerializedProperty property,
            Action<Object> itemSelectedCallback, string folderPath, Func<string, bool> fit = null)
        {
            ...
            Show(obj, requiredTypeName, property, itemSelectedCallback, folderPath, fit);
        }
            ...
            Action<Object> itemSelectedCallback, string folderPath, Func<string, bool> fit = null)
        {
            ...
            InitBuiltinList(requiredType, fit);
        ...
        /// <param name="requiredTypeName"></param>
        /// <param name="allowedInstanceIDs"></param>
        private void InitBuiltinList(string requiredTypeName, Func<string, bool> fit)
        {
            ...
            foreach (var guid in guids)
            {
                ...
                if (fit != null && fit(assetPath) == false) continue;
